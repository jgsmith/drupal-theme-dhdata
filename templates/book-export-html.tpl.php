...
<html xmlns="http://www.w3.org/1999/xhtml" lang="<?php print $language->language; ?>" xml:lang="<?php print $language->language; ?>" dir="<?php print $dir; ?>">
  <head>
    ...
    <link type="text/css" rel="stylesheet" href="<?php print drupal_get_path('theme', 'dhdata'). '/css/print.css'; ?>">
    <script src="<?php print drupal_get_path('theme', 'dhdata'). '/js/hyphenator.js'; ?>"></script>
    <?php if ($language_rtl): ?>
